...
INSERT INTO category (parent_id, is_root, is_leaf, sort_order, level, is_active, translations, created_at)
VALUES
    -- 1. Электроника (корневая)
    (NULL, true, false, 1, 0, true,
